...
pub const Encoder = WhiteEncoder(u64, u8, u16, u16);
/// The default white decoder instantiation (64-bit words, 8-bit headers, 16-bit hashes and cache).
pub const Decoder = WhiteDecoder(u64, u8, u16, u16);

pub fn WhiteEncoder(comptime Word: type, comptime Header: type, comptime Hash: type, comptime Cache: type) type {
...
pub fn WhiteDecoder(comptime Word: type, comptime Header: type, comptime Hash: type, comptime Cache: type) type {
    return struct {
        const Self = @This();
